...
export default function AddMaterialModal({
  ...
  const validateInputs = () => {
    return !!name && !!type && !!time && !!duration && !!durationType;
  };
            ...
            <>
              ...
              <ModalBody>
                <div className="flex flex-col gap-4 w-full">
                  ...
                  <Switch
                    defaultSelected
                    isSelected={previewable}
                    onValueChange={setPreviewable}
                  >
                    Previewable
                  </Switch>
                  <div className="flex flex-col gap-2">
                    <label htmlFor="time" className="text-tertiary">
                      Time
                    </label>
                    <StyledInputDateTime
                      value={time}
                      ...
                      id="time"
                      name="time"
                      className="border border-tertiary text-sm"
                    />
                  </div>
                  <div className="flex flex-col gap-2">
                    <label htmlFor="duration" className="text-tertiary">
                      Duration
                    </label>
